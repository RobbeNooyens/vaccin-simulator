...
class PlanningTests: public ::testing::Test {
protected:
...
*/
TEST_F(PlanningTests, DefaultConstructor) {
//    EXPECT_EQ(1, 1);
...
TEST_F(PlanningTests, LoadFromJSON) {
    Hub jsonHub = Hub();
...
TEST_F(PlanningTests, LoadFromJSONVaccineTypes) {
    Hub jsonHub = Hub();
...
TEST_F(PlanningTests, LoadFromJSONFail) {
